...
class MinAtarConfig():
    ...
    #actor critic
    actor: Dict = field(default_factory=lambda:{'layers':3, 'node_size':100, 'dist':'one_hot', 'min_std': 0.1, 'init_std':5, 'mean_scale':5, 'activation':nn.ELU, 'max_action': 1.0})
...
class FlatStateConfig():
    ...
    rssm_node_size: int = 64
    rssm_info: Dict = field(default_factory=lambda:{'deter_size':64, 'stoch_size':20, 'class_size':20, 'category_size':20, 'min_std':0.1})
    ...
    #actor critic
    actor: Dict = field(default_factory=lambda:{'layers':2, 'node_size':64, 'dist':'one_hot', 'min_std': 0.1, 'init_std':5, 'mean_scale':5, 'activation':nn.ELU, 'max_action': 1.0})
    # actor: Dict = field(default_factory=lambda:{'layers':3, 'node_size':100, 'dist':'trunc_normal', 'min_std': 0.1, 'init_std':5, 'mean_scale':5, 'activation':nn.ELU})
    critic: Dict = field(default_factory=lambda:{'layers':2, 'node_size':64, 'dist': 'normal', 'activation':nn.ELU})
    expl: Dict = field(default_factory=lambda:{'train_noise':0.4, 'eval_noise':0.0, 'expl_min':0.05, 'expl_decay':7000.0, 'expl_type':'epsilon_greedy', "decay_start":35_000})
    actor_grad: str ='dynamics'
    actor_grad_mix: int = 0.0
    actor_entropy_scale: float = 1e-4 
    ...
    #learnt world-models desc
    obs_encoder: Dict = field(default_factory=lambda:{'layers':2, 'node_size':64, 'dist': None, 'activation':nn.ELU, 'kernel':3, 'depth':16})
    obs_decoder: Dict = field(default_factory=lambda:{'layers':2, 'node_size':64, 'dist':'normal', 'activation':nn.ELU, 'kernel':3, 'depth':16})
    reward: Dict = field(default_factory=lambda:{'layers':2, 'node_size':64, 'dist':'normal', 'activation':nn.ELU})
    discount: Dict = field(default_factory=lambda:{'layers':2, 'node_size':64, 'dist':'binary', 'activation':nn.ELU, 'use':True})
