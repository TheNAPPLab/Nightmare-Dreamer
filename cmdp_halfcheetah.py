...
from CMBR.training.trainer_halfcheetah import Trainer, get_image_obs
...
def main(args):
    ...
    with wandb.init(project = 'Safe RL via Latent world models', config = config_dict):
        ...
        def evaluate_deter():
            ...
            eval_score, eval_score_cost = 0, 0
            ...
            with torch.no_grad():
                ...
                eval_next_obs, eval_reward, eval_cost, eval_terminated, eval_truncated, _ = \
                    env.step(eval_action.squeeze(0).cpu().numpy())
                eval_score_cost += eval_cost
                eval_score += eval_reward
                if eval_terminated or eval_truncated:
                    return eval_score, eval_score_cost
                else:
        ...
        for iter in range(1, trainer.config.train_steps):  
            ...
            if done_ :
                ...
                train_metrics['eval_rewards'], train_metrics['eval_costs'] = evaluate_deter()
