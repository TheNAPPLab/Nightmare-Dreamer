...
class ImagBehavior(nn.Module):
  ...
  def _imagine_safe(self, start, control_policy, safe_policy, repeats = None):
    ...
    def step(prev, _):
      ...
      control_action = control_policy(inp).sample()
      safe_action = safe_policy(inp).sample()
      succ = dynamics.img_step(state, control_action, sample=self._config.imag_sample)
      return succ, feat, control_action, safe_action
